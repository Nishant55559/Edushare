    ...
    <div
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="abc@example.com" type="emal" onChange={(e) => setEmail(e.target.value)}/>
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
        ...
        <div className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300 pt-5">
          <a href="/sign-up">Sign up</a> if you don&apos;t have an account yet{" "}
        </div>
      </form>
    </div>
  );
